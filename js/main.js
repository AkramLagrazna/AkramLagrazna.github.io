...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about.txt": "Hello 👋 I'm Akram Lagrazna. I’m a 20 yr old student currently living in London. I have a burning passion to want and help others with code that I create. I enjoy the limitless potential of impact that I can have with what I build. It is what pushes me every day to become a better developer. Outside of coding, you can find me making music!",
        "education.txt": "I'm a third year student at Middlesex University London, currently studying Computer Science!",
        "previous_work.txt": "You can find some of my old code on github.com/AkramLagrazna",
        "contact.txt": "You can contact me at lagrazna@protonmail.com !",
        "social_network_1.txt": "github.com/AkramLagrazna",
        "social_network_2.txt": "linkedin.com/AkramLagrazna"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
